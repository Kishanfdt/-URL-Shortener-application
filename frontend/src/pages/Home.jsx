...
const Home = () => {
  ...
  const handleGuestShorten = async (e) => {
    ...
    setLoading(true);
    try {
      // Post to public guest route
      const response = await api.post('/urls/guest', { originalUrl, expiresAt: expiresAt || undefined });
  ...
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ borderBottom: '1px solid rgba(255, 255, 255, 0.06)', backgroundColor: 'rgba(11, 14, 26, 0.6)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        {/* Pricing/Booking Section (BookMyShow theme style) */}
        <Box sx={{ 
          background: 'linear-gradient(180deg, rgba(21, 24, 41, 0.3) 0%, rgba(11, 14, 26, 0.6) 100%)', 
          py: 12, 
          ...
          <Container maxWidth="lg">
            <Typography variant="h4" align="center" sx={{ fontWeight: 800, mb: 1 }}>
              Select Your Plan Ticket
            </Typography>
            <Typography variant="body1" align="center" color="text.secondary" sx={{ mb: 8 }}>
              Choose the package tier that fits your team size and campaign targets.
            </Typography>
                ...
                <Card sx={{ 
                  ...
                  <CardContent sx={{ p: 4, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                      Perfect for individuals testing features.
                    </Typography>
                    <Box sx={{ mb: 4 }}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, mb: 4, flexGrow: 1 }}>
                      <Typography variant="body2">• 50 Short Links / month</Typography>
                      <Typography variant="body2">• Unlimited Guest Redirects</Typography>
                      <Typography variant="body2">• Standard QR Code downloads</Typography>
                      <Typography variant="body2">• basic click logs (last 10)</Typography>
                    </Box>
                    <Button variant="outlined" color="primary" fullWidth component={RouterLink} to="/signup">
                      Join Free Tier
                    </Button>
                  </CardContent>
                </Card>
              ...
              <Grid item xs={12} sm={4}>
                <Card
                  sx={{
                    ...
                    background: 'rgba(248, 68, 100, 0.03)',
                    '&:hover': {
                      transform: { md: 'scale(1.07) translateY(-4px)', xs: 'translateY(-4px)' },
                      boxShadow: '0 20px 45px rgba(248, 68, 100, 0.25)'
                    }
                  }}
                >
                  <Box
                  ...
                  <CardContent sx={{ p: 4, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    <Typography variant="h6" sx={{ fontWeight: 750, mb: 1, color: 'primary.main' }}>
                      Showstopper (Pro)
                    </Typography>
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                      Best for growing startups & marketers.
                    </Typography>
                    <Box sx={{ mb: 4 }}>
                      <Typography variant="h4" component="span" sx={{ fontWeight: 800 }}>
                        $9
                    ...
                    <Divider sx={{ mb: 4 }} />
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, mb: 4, flexGrow: 1 }}>
                      <Typography variant="body2">• <b>Unlimited</b> Short Links</Typography>
                      <Typography variant="body2">• Custom Aliases (e.g. /kishan)</Typography>
                      <Typography variant="body2">• Advanced Analytics Dashboards</Typography>
                      <Typography variant="body2">• High-res QR download vectors</Typography>
                      <Typography variant="body2">• OS, Geolocation & Browser charts</Typography>
                    </Box>
                    <Button variant="contained" color="primary" fullWidth component={RouterLink} to="/signup">
                      Book Pro Ticket
                    </Button>
                  </CardContent>
                </Card>
              ...
              <Grid item xs={12} sm={4}>
                <Card sx={{ 
                  ...
                  <CardContent sx={{ p: 4, flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
                      Dedicated infrastructure for high traffic.
                    </Typography>
                    <Box sx={{ mb: 4 }}>
                      <Typography variant="h4" component="span" sx={{ fontWeight: 800 }}>
                        $49
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, mb: 4, flexGrow: 1 }}>
                      ...
                      <Typography variant="body2">• Custom branded domain maps</Typography>
                      <Typography variant="body2">• Dedicated API SLA support</Typography>
                      <Typography variant="body2">• Advanced team management logs</Typography>
                    </Box>
                    <Button variant="outlined" color="primary" fullWidth component={RouterLink} to="/signup">
                      Contact Sales
                    </Button>
